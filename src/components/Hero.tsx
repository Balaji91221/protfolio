      ...
      <div className="lg:w-1/2 pb-4 lg:pl-16">
        <div className="flex flex-col px-6 sm:px-12 lg:pl-16">
          ...
          <h1 className="flex flex-col text-6xl font-black leading-none text-gray-800 uppercase font-bebas-neue sm:text-8xl dark:text-white">
            <span className="text-5xl sm:text-7xl">Kelavath Balaji Naik</span>
          </h1>
          <p className="text-sm text-gray-700 sm:text-base dark:text-white pt-6 text-justify md:text-left">
          Enthusiastic Computer Science student specializing in Artificial Intelligence and Machine Learning, with a keen interest in Full Stack Web Development. Dedicated to exploring innovative solutions and making a positive impact in the tech industry. I embark on a daily journey of continuous learning to embrace the endless possibilities in these dynamic fields. Let's connect and explore opportunities together!
          </p>

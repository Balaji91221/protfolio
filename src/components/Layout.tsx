...
const Layout: React.FC<any> = ({ children }: any) => {
  ...
  return (
    <div className="bg-Balaji-blur text-Balaji-900 dark:bg-Balaji-900 dark:text-Balaji-0 flex flex-col min-h-screen ">
      ...
      <div className="drawer">
            ...
            <div className="flex-1 px-2 mx-2">
              <div style={{ width: '6rem' }}>
                <Link to="/">
                  ...
                  <img loading="lazy" src="logo1.png" alt="Balaji LOGO" />
                </Link>
              </div>
            </div>
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 bg-Balaji-100 dark:bg-Balaji-700">
            <li>
            <div className="flex-1 px-2 mx-2">
              <div style={{ width: '6rem' }}>
                <Link to="/">

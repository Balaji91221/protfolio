    ...
    <>
      ...
      <div className="py-16 my-16 ">
        <div className="text-center w-3/4 m-auto">
          <div className="px-4 py-8 lg:py-16 bg-Balaji-200 dark:bg-Balaji-700 rounded-lg shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80">
            <p>
              This Website is made by  <a href="https://github.com/Balaji91221" target="_blank" rel="noopener noreferrer" className="font-semibold text-gray-900 underline dark:text-white decoration-blue-500">Kelavath Baljai Naik</a> using</p>
            ...
            <a href="https://github.com/Balaji91221" target="_blank" rel="noopener noreferrer" className="btn btn-primary">
              Source Code
            </a>
          </div>
        </div>
